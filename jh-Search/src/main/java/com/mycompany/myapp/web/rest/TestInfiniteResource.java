...
public class TestInfiniteResource {
    ...
    public ResponseEntity<TestInfinite> createTestInfinite(@RequestBody TestInfinite testInfinite) throws URISyntaxException {
        ...
        testInfiniteSearchRepository.save(result);
    ...
    /**
     * SEARCH  /_search/testInfinites/:query -> search for the testInfinite corresponding
     * to the query.
     */
    @RequestMapping(value = "/_search/testInfinites/{query:.+}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
